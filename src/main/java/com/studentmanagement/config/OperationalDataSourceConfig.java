 ...
 *   따라서 dev=create-drop / prod=validate(+Flyway) 동작이 유지된다.
 *
 * 참고: Flyway는 @Primary 운영 datasource를 대상으로 동작하며, Boot의
 * FlywayInitializerJpaDependencyConfiguration이 모든 EntityManagerFactory가 flyway
 * 이후 초기화되도록 순서를 보장한다(분석 EMF 포함, 무해).
 */
@Configuration
