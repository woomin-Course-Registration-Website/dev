  ...
  return (
    <aside className={clsx(
      ...
      <div className="px-3 py-4 border-t border-white/10 space-y-0.5">
        <NavLink
          to="/settings"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-primary-100 hover:bg-white/8 hover:text-white transition-all duration-150"
        >
