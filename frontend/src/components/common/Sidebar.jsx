...
const navItems = [
  ...
  { to: '/students',  label: '학생 목록',  icon: IconUsers },
  { to: '/grades',    label: '성적 관리',  icon: IconGrade },
  { to: '/feedback',  label: '피드백',     icon: IconFeedback },
  { to: '/counseling',label: '상담 관리',  icon: IconCounseling },
  { to: '/reports',   label: '보고서',     icon: IconReport },
  { to: '/analytics', label: '학습 분석',  icon: IconAnalytics, roles: ['TEACHER', 'ADMIN'] },
]
...
function IconFeedback({ className }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
function IconCounseling({ className }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
